	...
	<div class="tile_main">
		...
		<h1>Zarejestruj się</h1>
            ...
            <div class="has-icons-left has-icons-right">
                <input class="input is-danger" required type="email" name="email" placeholder="jan.kowalski@poczta.pl" <?php if(isset($_SESSION['user_data']['tmp_email'])) echo'value="',$_SESSION['user_data']['tmp_email'],'"'; ?> >
